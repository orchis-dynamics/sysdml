...
exports.VALID_REQUEST_TYPES = exports.WorkerState = void 0;
...
exports.VALID_REQUEST_TYPES = new Set([
    'init',
    'isInitialized',
    'reset',
    'configureWasm',
...
function isValidRequest(msg) {
    if (typeof msg !== 'object' || msg === null)
        return false;
    const obj = msg;
    return (typeof obj['type'] === 'string' && exports.VALID_REQUEST_TYPES.has(obj['type']) && typeof obj['requestId'] === 'number');
}
