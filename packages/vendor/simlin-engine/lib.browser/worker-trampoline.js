...
export function isCrossOrigin(workerUrl, pageOrigin) {
...
export function resolvePublicPathOverride(publicPath, workerUrl) {
...
export function workerTrampolineSource(absUrl, workerType, publicPathOverride) {
...
export function planWorkerCreation(args) {
...
export function spawnWithTrampoline(globalScope, spawn, env, urlFactory = URL) {
